...
def create_grid_polygon(lat, lon, cell_size=0.018, lon_cell_size=0.022):  # Unit：degree
...
calculate_similarity(f'{path}/centroidsv2.csv', f'Data&Result_{city}\Data\POI_overture_{city}_2025',
                     f'{path}/grid_with_pois.geojson', f'{path}/similarity_double_norm.csv',f'{path}/{city}_grid.geojson') #
